 ...
 * 
 */
@WebServiceClient(name = "helloService", targetNamespace = "http://demo.starmedia.shunwang.com/rpc/jws/server", wsdlLocation = "http://localhost/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://demo.starmedia.shunwang.com/rpc/jws/server", "helloService");
     ...
     * 
     * @return
     *     returns RmiHelloService
     */
    @WebEndpoint(name = "helloServicePort")
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://demo.starmedia.shunwang.com/rpc/jws/server", "helloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.starmedia.shunwang.com/rpc/jws/server", "helloServicePort"), HelloService.class, features);
    }
